...
export function createApp(): Express {
  ...
  // Readiness: checks Postgres AND Redis - this service's invoice-
  // generation worker depends on Redis being reachable to pick up queued
  // jobs; a Postgres-only check previously missed that.
