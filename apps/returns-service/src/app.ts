...
import { customerReturnsRouter } from './routes/customer.routes';
import { adminReturnsRouter } from './routes/admin.routes';
...
export function createApp(): Express {
  ...
  // Readiness: actually checks DB connectivity as the returns_svc role.
  ...
  app.use('/admin/returns', adminReturnsRouter);
  app.use('/returns', customerReturnsRouter);
